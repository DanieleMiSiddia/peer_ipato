...
@Component({
    selector: 'app-aggiungi-co-chair',
    templateUrl: './aggiungi-co-chair.page.html',
    styleUrls: ['./aggiungi-co-chair.page.scss'],
    standalone: true,
    imports: [CommonModule, FormsModule, IonContent]
})
export class AggiungiCoChairPage implements OnInit {
    email          = '';
    errorMessage   = '';
    successMessage = '';
    loading        = false;
    ...
    submit(): void {
        ...
        this.chairService.aggiungiCoChair(this.token, this.idConferenza, this.email.trim()).subscribe({
            next: () => {
                this.loading = false;
                this.successMessage = 'Co-Chair aggiunto con successo!';
