document.addEventListener('DOMContentLoaded', () => {
    ...
    const btnAnnulla = document.getElementById('btn-annulla')   as HTMLButtonElement;
    ...
    form.addEventListener('submit', async (e: Event) => {
        ...
        try {
            const response = await fetch(`/api/dashboard-chair/conferenze/${id_conferenza}/co-chair`, {
                method: 'POST',
                headers: {
